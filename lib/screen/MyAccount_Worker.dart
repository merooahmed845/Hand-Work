...
class MyAccountWorker extends StatefulWidget {
  @override
  _MyAccountWorkerState createState() => _MyAccountWorkerState();
}

class _MyAccountWorkerState extends State<MyAccountWorker> {
